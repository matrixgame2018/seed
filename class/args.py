...
#-*- coding:utf-8 _*-
import argparse
from media_stom.build_net import model_names
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='D:/pycharm_object/media_stom/media_stom/checkpoint/data0/res_16_288_last1', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnext101_32x16d_wsl',choices=model_names,
